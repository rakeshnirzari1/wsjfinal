      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-xl font-bold">Western Sydney Jobs</h3>
            </div>
            <p className="text-gray-400 mb-6 max-w-md">
              The premier destination for jobs in Western Sydney. 
              Connect with top employers and find your dream role in Western Sydney.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-400">
                ...
                support@westernsydneyjobs.com.au
              </li>
              <li className="flex items-center text-gray-400">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2025 Western Sydney Jobs. All rights reserved.
          </p>
